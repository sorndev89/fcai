...
// ──────────────────────────────────────────────
async function callOpenAiCompatible(config, systemInstruction, messages, userMessage, temperature = 0.1) {
...
// ──────────────────────────────────────────────
async function callGemini(config, systemInstruction, prompt, temperature = 0.1) {
...
// ──────────────────────────────────────────────
async function callAiProvider(config, systemInstruction, messages, userMessage, temperature = 0.1) {
 ...
 */
async function generateAiResponse(incomingMessage, knowledgeBase, customerName, customerNotes, chatHistory) {
 ...
 */
async function extractOrderSummary(chatLogsText) {
    const config = await getActiveAiConfig();
    if (!config || !config.apiKey) {
